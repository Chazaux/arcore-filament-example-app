package com.artest.egresine.aractivity
...
import com.artest.egresine.OpenGLVersionNotSupported
import com.artest.egresine.PermissionResultEvent
import com.artest.egresine.R
import com.artest.egresine.UserCanceled
import com.artest.egresine.arcore.ArCore
import com.artest.egresine.cameraPermissionRequestCode
import com.artest.egresine.checkIfOpenGlVersionSupported
import com.artest.egresine.databinding.ExampleActivityBinding
import com.artest.egresine.filament.Filament
import com.artest.egresine.gesture.DragGesture
import com.artest.egresine.gesture.DragGestureRecognizer
import com.artest.egresine.gesture.PinchGesture
import com.artest.egresine.gesture.PinchGestureRecognizer
import com.artest.egresine.gesture.TransformationSystem
import com.artest.egresine.gesture.TwistGesture
import com.artest.egresine.gesture.TwistGestureRecognizer
import com.artest.egresine.minOpenGlVersion
import com.artest.egresine.renderer.FrameCallback
import com.artest.egresine.renderer.LightRenderer
import com.artest.egresine.renderer.ModelRenderer
import com.artest.egresine.renderer.PlaneRenderer
import com.artest.egresine.showOpenGlNotSupportedDialog
import com.artest.egresine.toRadians
import com.artest.egresine.x
import com.artest.egresine.y
...
class ArActivity : AppCompatActivity() {
    ...
    private var planesDetected = false
                    ...
                    with(CoroutineScope(coroutineContext)) {
                        ...
                        launch {
                            dragEvents
                                ...
                                .collect {
                                    // modelRenderer.modelEvents.tryEmit(it)
                                }
                        }
        ...
        try {
            ...
            coroutineScope {
                ...
                launch(coroutineContext) {
                    arCore.onPlaneDetected = { planes ->
                        if (!planesDetected && planes.isNotEmpty()) {
                            planesDetected = true
                            Log.d("TAG", "Plans détectés: ${planes.size}")
                        }
                        binding.overlayView.updatePlanes(planes)
                    }
