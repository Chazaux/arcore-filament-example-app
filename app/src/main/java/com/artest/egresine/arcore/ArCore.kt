...
import com.artest.egresine.M4
import com.artest.egresine.V2A
import com.artest.egresine.count
import com.artest.egresine.createExternalTextureId
import com.artest.egresine.dimenV2A
import com.artest.egresine.filament.Filament
import com.artest.egresine.m4Identity
import com.artest.egresine.matrix
import com.artest.egresine.projectionMatrix
import com.artest.egresine.readUncompressedAsset
import com.artest.egresine.rotate
import com.artest.egresine.set
import com.artest.egresine.toDoubleArray
import com.artest.egresine.toFloatBuffer
import com.artest.egresine.toShortBuffer
import com.artest.egresine.translate
...
class ArCore(private val activity: Activity, val filament: Filament, private val view: View) {
    ...
    var onPlaneDetected: ((List<Plane>) -> Unit)? = null
                ...
                if (hasDepthImage.not()) {
                    try {
                        ...
                        if (updatedPlanes.isNotEmpty()) {
                            onPlaneDetected?.invoke(updatedPlanes.toList())
                        }
